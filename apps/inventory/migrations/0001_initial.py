...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'QuantityEmployedTool', fields ['tool', 'quantity', 'employed_order']
        db.create_unique(u'inventory_quantityemployedtool', ['tool_id', 'quantity', 'employed_order_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'QuantityEmployedTool', fields ['tool', 'quantity', 'employed_order']
        db.delete_unique(u'inventory_quantityemployedtool', ['tool_id', 'quantity', 'employed_order_id'])
    ...
    models = {
        ...
        u'inventory.quantityemployedtool': {
            'Meta': {'unique_together': "(('tool', 'quantity', 'employed_order'),)", 'object_name': 'QuantityEmployedTool'},
            'date_added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
