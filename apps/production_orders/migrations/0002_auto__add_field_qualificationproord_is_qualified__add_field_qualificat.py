...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QualificationProOrd.is_qualified'
        db.add_column(u'production_orders_qualificationproord', 'is_qualified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'QualificationProOrd.is_verified'
        db.add_column(u'production_orders_qualificationproord', 'is_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QualificationProOrd.is_qualified'
        db.delete_column(u'production_orders_qualificationproord', 'is_qualified')

        # Deleting field 'QualificationProOrd.is_verified'
        db.delete_column(u'production_orders_qualificationproord', 'is_verified')
