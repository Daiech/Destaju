...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QualificationProOrd.date_qualified'
        db.add_column(u'production_orders_qualificationproord', 'date_qualified',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'QualificationProOrd.date_verified'
        db.add_column(u'production_orders_qualificationproord', 'date_verified',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QualificationProOrd.date_qualified'
        db.delete_column(u'production_orders_qualificationproord', 'date_qualified')

        # Deleting field 'QualificationProOrd.date_verified'
        db.delete_column(u'production_orders_qualificationproord', 'date_verified')
    ...
    models = {
        ...
        u'production_orders.qualificationproord': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'qualificationproord_user'", 'to': u"orm['auth.User']"}),
